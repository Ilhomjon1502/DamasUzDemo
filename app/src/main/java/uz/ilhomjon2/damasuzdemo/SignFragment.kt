...
import uz.ilhomjon2.damasuzdemo.databinding.FragmentSignBinding
...
class SignFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        alertDialog.setMessage("Assalomu alaykum! Iltimos dastur to'g'ri ishlashi uchun GPS va internetni yoqishingizni so'raymiz... Dastur Ilhomjon Ibragimov tomonidan ishlab chiqildi va test rejimiga qo'yildi. Murojaat uchun @IlhomjonDeveloper tegeram orqali")
        alertDialog.setPositiveButton("Xo'p", object : DialogInterface.OnClickListener {
